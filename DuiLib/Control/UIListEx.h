...
namespace DuiLib {
	...
	private:
		...
		tstring m_sCheckBoxNormalImage;
		tstring m_sCheckBoxHotImage;
		tstring m_sCheckBoxPushedImage;
		tstring m_sCheckBoxFocusedImage;
		tstring m_sCheckBoxDisabledImage;

		tstring m_sCheckBoxSelectedImage;
		tstring m_sCheckBoxForeImage;

		SIZE m_cxyCheckBox;

	public:
		BOOL DrawCheckBoxImage(HDC hDC, LPCTSTR pStrImage, LPCTSTR pStrModify = NULL);
		BOOL DrawCheckBoxImage(HDC hDC, const tstring& sImage, LPCTSTR pStrModify = NULL) { return DrawCheckBoxImage(hDC, sImage.c_str(), pStrModify); }
		BOOL DrawCheckBoxImage(HDC hDC, const tstring& sImage, const tstring& sModify) { return DrawCheckBoxImage(hDC, sImage.c_str(), sModify.c_str()); }
	...
	public:
		...
		BOOL DrawCheckBoxImage(HDC hDC, const tstring& sImage, LPCTSTR pStrModify, RECT& rcCheckBox) { return DrawCheckBoxImage(hDC, sImage.c_str(), pStrModify, rcCheckBox); }
		BOOL DrawCheckBoxImage(HDC hDC, const tstring& sImage, const tstring& sModify, RECT& rcCheckBox) { return DrawCheckBoxImage(hDC, sImage.c_str(), sModify.c_str(), rcCheckBox); }
		LPCTSTR GetCheckBoxNormalImage();
		void SetCheckBoxNormalImage(LPCTSTR pStrImage);
		LPCTSTR GetCheckBoxHotImage();
		void SetCheckBoxHotImage(LPCTSTR pStrImage);
